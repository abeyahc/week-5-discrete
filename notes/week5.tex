...
\sol{
    ...
    \textbf{b.} \;
        ...
        & \text{are integers and because} \; \textbf{the sum of integers is also an integer} \\
    \textbf{c.} \;
        & \text{Hence $m+n=2u$, where $u$ is an integer, and so,} \\
        & \text{by \textbf{definition of even}, $m+n$ is even.} \\
    \end{align*}
}
